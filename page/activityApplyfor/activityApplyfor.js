...
angular
    ...
    .controller('queryOperateResultCtrl', ['$scope', '$rootScope', '$log', '$uibModal', 'paramData', 'httpConfig', 'httpMethod', function ($scope, $rootScope, $log, $uibModal, paramData, httpConfig, httpMethod) {
        ...
        //弹窗
        $scope.requestNote = function(item, title) {
            $rootScope.requstTitle = title;
    ...
    .controller('resourcesModalCtrl', ['$uibModalInstance', '$scope', '$log', 'items', function($uibModalInstance, $scope, $log, items) {
        var $ctrl = this;
        $ctrl.items = items;
