    ...
    load: function () {
        require.config({
            paths: {
                ...
                'angular-sortable-view': '../../resources/js/angular-sortable-view'
            },
            shim: {
                'angular': {
                    'exports': 'angular'
...
window.loading.load();
require(['angular', 'resourceStarAndNetworkAgeRelationAllocation'], function (angular) {
    angular.bootstrap(document, ['resourceStarAndNetworkAgeRelationAllocationModule']);
